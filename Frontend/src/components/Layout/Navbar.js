                        ...
                        <AnimatePresence>
                            {showProfileMenu && (
                                ...
                                >
                                    ...
                                    <button className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                                        <User size={18} />
                                        My Profile
                                    </button>
